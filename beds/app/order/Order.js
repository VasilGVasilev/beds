            ...
            <div className="bg-white p-20 w-full h-full flex-col justify-center items-center space-y-5 text-black text-justify font-semibold">
                ...
                >
                    ...
                    <div className="md:basis-5/6 justify-center items-center" >
                        За да получите ценова оферта за падащи легла, можете да направите обаждане на нашия телефон <a className="text-green-600" href={`tel:00359888368256`}>0888368256</a>.
                    </div>
                </motion.div>
                <motion.div
                    initial="hidden"
